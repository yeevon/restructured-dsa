...
Architect reads design_docs/MANIFEST.md, CLAUDE.md, design_docs/architecture.md, all of design_docs/decisions/, all of design_docs/project_issues/, and all of design_docs/tasks/, then writes the next TASK-NNN file.
